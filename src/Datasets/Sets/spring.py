...
# spring.py
#
# After loading all datasets then aggregating them, the following class can be used to create exploratory datasets from the spring data
# Spring data appears in the following date ranges:
#   - Daily: March 1st - April 30th (inclsuive)
#   - Weekly: Week 9 - Week 16 (inclusive)
...
class Spring(AbstractSet):
    ...
    def selectData(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        Purpose:
        Selects data for the spring set
