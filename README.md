...
```git clone https://github.com/DaneHarrison/CGC_Grain_Outcome_Predictions.git```
...
**NOTE**: Gathering and aggregating data can easily be done using the [loadData notebook](https://github.com/DaneHarrison/CGC_Grain_Outcome_Predictions/blob/main/src/loadData.ipynb) 
